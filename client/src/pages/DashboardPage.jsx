...
export default function DashboardPage() {
  ...
  async function loadData() {
    ...
    const [summaryRes, chartRes, recentRes, reminderRes] =
  ...
  return (
    <div className="space-y-6">
      <section className="dashboard-welcome">
        <div>
          <span className="eyebrow">VOTRE ESPACE, VOTRE AMBITION</span>
          <h2>
            Bonjour {user?.fullName?.split(" ")[0] || "et bienvenue"}
            <span className="text-teal-600">.</span>
          </h2>
          <p>Une vue claire pour prendre les bonnes décisions aujourd’hui.</p>
        </div>
        <div className="flex flex-wrap gap-2">
          <Link to="/clients" className="btn-secondary gap-2">
            Mes clients <ArrowUpRight size={16} />
          </Link>
          <Link to="/quotes" className="btn-primary gap-2">
            Mes devis <ArrowUpRight size={16} />
          </Link>
        </div>
      </section>
                ...
                >
                  ...
                  <td className="py-3">
                    ...
                    <p className="text-xs text-slate-500">
                      {quote.clientCompany || "Sans entreprise"}
                    </p>
                  </td>
